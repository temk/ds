...
extern "C" {
  ...
  void * ds_add_column(void *ds, int type, const char *name, int endian, int index );
  void * ds_add_column_str(void *ds, int type, int dict_type, const char *name, int endian, int index );
